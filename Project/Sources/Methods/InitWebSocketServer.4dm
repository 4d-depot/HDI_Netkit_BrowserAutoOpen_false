...
var $handler : cs:C1710.WSSGmailBox
...
$handler:=cs:C1710.WSSGmailBox.new()

// Creation of the websocket server 
CALL WORKER:C1389("WebSocketServer"; Formula:C1597(WebSocketServer:=WebSocketServer || 4D:C1709.WebSocketServer.new($handler; {dataType: "object"})))